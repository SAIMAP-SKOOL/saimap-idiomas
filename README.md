...
en total). Inglés A2 sigue con el esquema plano (25 módulos × 30). B1-C2 visibles pero bloqueados.
...
- ✅ Mapa del curso con nodos en serpentina y desbloqueo encadenado también ENTRE niveles y
  ENTRE subniveles (p. ej. A2-mod01 exige completar el subnivel 25.5 de A1)
...
- ✅ **Módulos subdivididos en 5 subniveles** (banco de 15 ejercicios cada uno, 3 por tipo,
  sesión de 10) — esquema completo en **Inglés A1**. El resto de módulos (Inglés A2, Latín A1)
  sigue con el esquema plano de 30 ejercicios / sesión de 12. Ver «Esquema de subniveles» más abajo.
